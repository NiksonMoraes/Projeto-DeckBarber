...
if (conta == 0) {
    ...
    if (cliente.getCont_cortes() < 10) {
        ...
        if (escolhabarb == 1) {
            ...
            System.out.println(joao.getNome() + " este corte lhe rendeu R$" + saldobarb1 / 2
                    + " e seu valor diário geral é de: R$" + saldobarb1 + "\n\n\n\n");
            Double saldoSemDescontos = saldoGerente + valorProdutoSeparado + contacorte;
            custoProdutos = custoProdutos + (minoxidil.getValorDeCusto() * estoqueMinoxidil.getCount_Produto()) + (creme.getValorDeCusto() * estoqueCreme.getCount_Produto());
            valorbarbeiros = saldobarb1 + saldobarb2 + saldobarb3;
            ...
            System.out.println("GERENTE:" +
                    ...
                    "\na comissão dos barbeiros está nos valores de: Jorge: " + saldobarb1 + " João:"
                    + saldobarb2 + " Paulo:" + saldobarb3 +
            ...
            System.out.println(joao.getNome() + " este corte lhe rendeu R$" + saldobarb2 / 2
                    + " e seu valor diário geral é de: R$" + saldobarb2 + "\n\n\n\n");
            Double saldoSemDescontos = saldoGerente + valorProdutoSeparado + contacorte;
             custoProdutos = custoProdutos + (minoxidil.getValorDeCusto() * estoqueMinoxidil.getCount_Produto()) + (creme.getValorDeCusto() * estoqueCreme.getCount_Produto());
            valorbarbeiros = saldobarb1 + saldobarb2 + saldobarb3;
            double descontos = valorbarbeiros + custoProdutos;
            ...
            System.out.println(joao.getNome() + " este corte lhe rendeu R$" + saldobarb3 / 2
                    + " e seu valor diário geral é de: R$" + saldobarb3 + "\n\n\n\n");
            Double saldoSemDescontos = saldoGerente + valorProdutoSeparado + contacorte;
             custoProdutos = custoProdutos + (minoxidil.getValorDeCusto() * estoqueMinoxidil.getCount_Produto()) + (creme.getValorDeCusto() * estoqueCreme.getCount_Produto());
            valorbarbeiros = saldobarb1 + saldobarb2 + saldobarb3;
            double descontos = valorbarbeiros + custoProdutos;
